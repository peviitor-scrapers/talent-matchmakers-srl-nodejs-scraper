...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "Talent Matchmakers") |
| group        | string   | Parent company group (e.g. "Talent Matchmakers Group") |
...
| scraperFile  | string   | Full URL to the GitHub Actions workflow (no raw, e.g. `https://github.com/peviitor-scrapers/talent-matchmakers-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml`) |
...
- **scraperFile**: Full URL to the GitHub Actions workflow (no raw, e.g. `https://github.com/peviitor-scrapers/talent-matchmakers-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml`)