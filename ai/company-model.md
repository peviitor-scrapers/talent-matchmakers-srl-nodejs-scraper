...
| scraperFile  | string   | Full URL to the GitHub Actions workflow (no raw, e.g. `https://github.com/sebiboga/talent-matchmakers-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml`) |
...
- **scraperFile**: Full URL to the GitHub Actions workflow (no raw, e.g. `https://github.com/sebiboga/talent-matchmakers-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml`)