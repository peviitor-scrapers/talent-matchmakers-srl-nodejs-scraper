...
```bash
gh issue list --repo peviitor-scrapers/talent-matchmakers-srl-nodejs-scraper --state open
```
...
6. Commit with issue reference (e.g., `fix: resolve #2`)
7. Push
...
- `docs/test-results/index.html` — branding must say "TALENT MATCHMAKERS", not the old template
